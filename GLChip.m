...
-(void)draw
{
    ...
    stackVectors = malloc( 8 * (30 + 1) * sizeof(Vector3D));
    stackTexture = malloc( 8 * (30 + 1) * sizeof(Vector2D));
    stackMesh    = malloc(12 * (30 + 1) * sizeof(GLushort));
    stackColors  = malloc( 8 * (30 + 1) * sizeof(Color3D));
