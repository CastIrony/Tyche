...
-(void)updateCamera
{
    if(self.menuVisible)
    {
        if(self.renderer.animated)
        {
            ...
            self.position    = [AnimatedVector3D withStartValue:self.position.value    endValue:Vector3DMake(0, 0.0, -10) forTime:1];  
        ...
        else 
        {
            ...
            self.position    = [AnimatedVector3D withValue:Vector3DMake(0, 0.0, -10)]; 
