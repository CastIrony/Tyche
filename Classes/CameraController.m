...
-(void)updateCamera
{
    if(self.menuVisible)
    {
        if(self.renderer.animated)
        {
            ...
            self.position    = [AnimatedVector3D withStartValue:self.position.value    endValue:Vector3DMake(0, 0.0, -15) forTime:1];  
        ...
        else 
        {
            ...
            self.position    = [AnimatedVector3D withValue:Vector3DMake(0, 0.0, -15)]; 
    ...
    else 
    {
        if(self.status == CameraStatusCardsFlipped)
        {
            if(self.renderer.animated)
            {
                ...
                self.position    = [AnimatedVector3D withStartValue:self.position.value    endValue:Vector3DMake(0, 2.3, -25) forTime:1]; 
